    ...
    webpackConfig.plugins.push(
      new webpack.DefinePlugin({
        "process.env": {
          ...
          API_ENDPOINT: JSON.stringify(process.env.API_ENDPOINT || "http://koulis.athenarc.gr:8080/uoa-repository-manager-service"),
          FAQ_ENDPOINT: JSON.stringify(process.env.FAQ_ENDPOINT || "https:/demo.openminted.eu/provide/api"),
          AAI_ENDPOINT: JSON.stringify(process.env.AAI_ENDPOINT || "http://koulis.athenarc.gr:8080/uoa-repository-manager-service/openid_connect_login"),
    ...
    webpackConfig.plugins.push(
      new webpack.DefinePlugin({
        "process.env": {
          ...
          API_ENDPOINT: JSON.stringify("http://koulis.athenarc.gr:8080/uoa-repository-manager-service"),
          FAQ_ENDPOINT: JSON.stringify("http://audrey.athenarc.gr:5555/api"),
          AAI_ENDPOINT: JSON.stringify("http://koulis.athenarc.gr:8080/uoa-repository-manager-service/openid_connect_login"),
