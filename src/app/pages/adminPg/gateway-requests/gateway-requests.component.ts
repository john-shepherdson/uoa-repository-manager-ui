...
export class GatewayRequestsComponent implements OnInit {
  ...
  statusOptions: Option[] = [
    ...
    constructor(private requestsService: RequestsService, private sharedService: SharedService, private repositoryService: RepositoryService, private router: Router, private route: ActivatedRoute){}
...
//     ids.forEach(id => {
//       this.requestsService.getRequestsbyId('openaire-infrastructure', 'sourceGatewayId').subscribe(
//         next => {
