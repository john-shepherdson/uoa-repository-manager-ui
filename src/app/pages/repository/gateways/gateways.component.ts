...
export class GatewaysComponent implements OnInit {
  ...
  approveRequest(requestId: number) {
    ...
    this.requestsService.createRequestDecision(requestId, Decision.APPROVED, Authority.DATASOURCE_ADMIN, 'Approved by admin')
      .subscribe({
        next: (res) => {
  ...
  rejectRequest(requestId: number) {
    ...
    this.requestsService.createRequestDecision(requestId, Decision.REJECTED, Authority.DATASOURCE_ADMIN, 'Rejected by admin')
      .subscribe({
        next: (res) => {
